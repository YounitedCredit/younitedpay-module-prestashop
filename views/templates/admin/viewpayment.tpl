...
<div class="panel">
    <div class="panel-heading">
        <i class="icon-cogs"></i>{l s='Payment' mod='younitedpay'}
    </div>
    <div class="panel-body">
        ...
        <div class="tab-pane" id="younitedpay">
            <p>
                ...
                {$younitedpayment->payment_id|escape:'html':'UTF-8'}
            </p>

            <p>
                <b>{l s='Contract Reference' mod='younitedpay'}</b><br />
                {$younitedpayment->id_external_younitedpay_contract|escape:'htmlall':'UTF-8'}
            </p>

            <p>
                <b>{l s='Cart ID' mod='younitedpay'}</b><br />
                {$younitedpayment->id_cart|escape:'htmlall':'UTF-8'}
            </p>
        </div>
        ...
        <a href="{$payments_url|escape:'htmlall':'UTF-8'}" class="btn btn-primary pull-right">{l s='Back' mod='younitedpay'}</a>
    </div>
</div>
