...
use YounitedpayClasslib\Utils\CacheStorage\Exception\CacheException;
...
class CacheStorage
{
     ...
     * @var string
     */
    protected $directory = _PS_CACHE_DIR_ . 'younitedpay/';
    ...
    protected function createCacheDirectoriesIfNotExists()
    {
        ...
        $this->createCacheDirectory(_PS_CACHE_DIR_ . 'younitedpay/');
