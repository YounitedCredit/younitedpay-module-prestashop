...
class ProcessLoggerExtension extends AbstractModuleExtension
{
    ...
    const QUIET_MODE = 'YOUNITEDPAY-PRESTASHOP_PROCESS_LOGGER_QUIET_MODE';

    const ERASING_DISABLED = 'YOUNITEDPAY-PRESTASHOP_EXTLOGS_ERASING_DISABLED';

    const ERASING_DAYSMAX = 'YOUNITEDPAY-PRESTASHOP_EXTLOGS_ERASING_DAYSMAX';
