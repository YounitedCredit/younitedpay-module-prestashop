...
use YounitedpayClasslib\Extensions\ProcessMonitor\ProcessMonitorHandler;
use Configuration;
use Db;
use Hook;
use Tools;
...
class ProcessLoggerHandler
{
    ...
    public static function saveLogsInDb()
    {
        ...
        if (false === empty(self::$logs) && self::getSkippingHooksResult()) {
            ...
            Hook::exec(
                'actionYounitedpayProcessLoggerSave',
                [
                    'logs' => &self::$logs,
                ],
                null,
     ...
     * 'actionSkipYounitedpayProcessLoggerSave' returns false (weak comparison)
     *
     * @return bool
     *
     * @throws \PrestaShopException
    ...
    protected static function getSkippingHooksResult()
    {
        ...
        if (Hook::getIdByName('actionSkipYounitedpayProcessLoggerSave')) {
            $hookModuleProcessLoggerReturnArray = Hook::exec(
                'actionSkipYounitedpayProcessLoggerSave',
                [
                    'logs' => self::$logs,
                ],
                null,
