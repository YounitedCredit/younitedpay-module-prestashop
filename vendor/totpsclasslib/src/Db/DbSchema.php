...
{
    /**
     * @var YounitedpayClasslib\Db\ObjectModelDefinition
     */
    protected $def;
    ...
    /**
     * Register YounitedpayClasslib\Db\ObjectModelDefinition and table (internal) ID
     * @param YounitedpayClasslib\Db\ObjectModelDefinition $def
     * @param string                $id
     */
     ...
     * @param YounitedpayClasslib\Db\DbTable $table
     * @return YounitedpayClasslib\Db\DbTable
     */
