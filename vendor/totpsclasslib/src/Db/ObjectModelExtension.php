...
namespace YounitedpayClasslib\Db;

use YounitedpayClasslib\Db\ObjectModelDefinition;
use YounitedpayClasslib\Db\DbTableDefinitionModel;
use YounitedpayClasslib\Db\DbTableDefinitionRelation;
use YounitedpayClasslib\Db\DbSchema;
use YounitedpayClasslib\Db\DbTable;
...
class ObjectModelExtension
{
    ...
    /**
     * @return YounitedpayClasslib\Db\ObjectModelDefinition (as an array collection object)
     */
    ...
    /**
     * @param YounitedpayClasslib\Db\DbSchema $schema
     * @return bool
     */
