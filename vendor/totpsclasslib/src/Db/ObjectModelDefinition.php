...
class ObjectModelDefinition
{
    ...
    /**
     * @var array of YounitedpayClasslib\Db\DbTableDefinitionRelation
     */
    protected $relations;
    ...
    /**
     * @param string $id
     * @return YounitedpayClasslib\Db\DbSchema
     */
    ...
    /**
     * @param string $id
     * @return YounitedpayClasslib\Db\DbTableDefinitionRelation
     */
